...
EVENT = os.path.join(EVENT_DIR, 'GetExifCameraData-event-eb.json')
EVENT_SCHEMA = os.path.join(SCHEMA_DIR, 'ExifDataItem.schema.json')
RESPONSE = os.path.join(EVENT_DIR, 'GetExifCameraData-output.json')
DATA_SCHEMA = os.path.join(SCHEMA_DIR, 'CameraExifData.schema.json')
RESPONSE_SCHEMA = os.path.join(SCHEMA_DIR, 'GetExifCameraDataResponse.schema.json')

### Events
@pytest.fixture()
def context():
    '''context object'''
    return create_lambda_function_context('GetExifCameraData')
