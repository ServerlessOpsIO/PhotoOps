...
EVENT = os.path.join(EVENT_DIR, 'GetExifLocationData-event-eb.json')
EVENT_SCHEMA = os.path.join(SCHEMA_DIR, 'ExifDataItem.schema.json')
RESPONSE = os.path.join(EVENT_DIR, 'GetExifLocationData-output.json')
DATA_SCHEMA = os.path.join(SCHEMA_DIR, 'LocationExifData.schema.json')
